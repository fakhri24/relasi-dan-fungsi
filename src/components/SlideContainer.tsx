...
export const SlideContainer: React.FC<SlideContainerProps> = ({
  ...
  return (
    <main className="no-print flex-1 h-[calc(100vh-3.5rem)] max-h-[calc(100vh-3.5rem)] w-full max-w-7xl mx-auto p-2 md:p-4 flex flex-col justify-center items-center overflow-hidden">
      <div className="slide-container-frame w-full h-full bg-slate-950/80 rounded-2xl md:rounded-3xl p-3 md:p-6 flex flex-col justify-between overflow-hidden border border-slate-900 shadow-2xl transition-colors duration-200">
        {children}
      </div>
    </main>
  );
