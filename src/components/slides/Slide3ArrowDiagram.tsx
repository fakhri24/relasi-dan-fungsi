...
const PRESETS: Preset[] = [
  {
    ...
    isFunction: true,
    verdict: 'FUNGSI SAH',
    reason: 'Tepat 1 pasangan tiap anggota A',
  },
  {
    id: 'invalid-jomblo',
    name: 'Kasus 2: Jomblo',
    ...
    isFunction: false,
    verdict: 'BUKAN FUNGSI',
    reason: 'Citra tidak berpasangan',
  },
  {
    id: 'invalid-mendua',
    name: 'Kasus 3: Mendua',
    ...
    isFunction: false,
    verdict: 'BUKAN FUNGSI',
    reason: 'Budi bercabang 2 panah',
  },
  {
    id: 'valid-konstan',
    name: 'Kasus 4: Konstan',
    arrows: [[0, 0], [1, 0], [2, 0], [3, 0]],
    isFunction: true,
    verdict: 'FUNGSI SAH',
    reason: 'Semua memilih sama (Konstan)',
  },
];
    ...
    <div className="flex flex-col h-full justify-between max-w-6xl mx-auto">
      ...
      <div className="space-y-1">
        <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-brand-500/10 border border-brand-500/30 text-brand-400 text-xs font-mono font-bold tracking-wider uppercase">
          <GitFork className="w-3.5 h-3.5" /> 04 · DIAGRAM
        </div>
        ...
        <div className="md:col-span-5 flex flex-col justify-center h-full space-y-4">
          {revealed ? (
            ...
            <button
              ...
              className="py-3 px-6 rounded-xl bg-brand-600 hover:bg-brand-500 text-white font-bold text-base shadow-xl transition-all flex items-center justify-center gap-2"
            >
      ...
      <div className="bg-slate-900 border-l-4 border-brand-500 px-4 py-2.5 rounded-r-xl flex items-center justify-between mt-1 shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <p className="text-slate-200 text-sm md:text-base font-semibold">
            Daerah Asal (Domain): Wajib berpasangan & tidak boleh bercabang
          </p>
        </div>
      </div>
    </div>
